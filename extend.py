...
if __name__ == '__main__':
    ...
    lr_signal, condition_fs = librosa.load(os.path.join('inputs', args.lr_signal), duration=args.length, sr=None)
    ...
    #    hr_signal, hr_fs = librosa.load(os.path.join('inputs', args.lr_signal.replace('_lr', '_hr')), duration=args.length,
